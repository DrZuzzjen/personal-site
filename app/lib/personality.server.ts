/**
 * SERVER-SIDE ONLY Personality Configuration
 * This file contains sensitive information and should NEVER be imported on the client
...
// Helper to generate context for LLM (SERVER-SIDE ONLY)
...
#IMPORTANT!!: ALWAYS REPLY SHORT, LIKE A CHAT, THIS IS NOT A FORMAL CONVERSATION, KEEP IT SUPER SHORT UNLESS IS NECESARY TO EXPAND`;
}
